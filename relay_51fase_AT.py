...
i_sobrecarga = 1.4 * i_nominal_230kV
...
if i_pickup < i_sobrecarga: 
    print(f"PRECISAREMOS DE 51 V EM SÉRIE, POIS A CORRENTE DO MENOR CURTO OBSERVADO ({icc_min_230kV} A) "
...
print(f"Usando pickup PRIMÁRIO para a função 51 fase do relé de 230kV igual à {round(i_pickup, 3)} A")
